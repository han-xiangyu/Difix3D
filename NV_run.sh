...
python render_video_difix_horizon_sine.py /lustre/fsw/portfolios/nvr/users/ymingli/gaussian/model/spatial05_frames3000_with_multi_frame_depth/horizontal_sine/ --fps 15
