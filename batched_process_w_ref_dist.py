...
def worker(rank, device, task_list, model_id, prompt, num_inference_steps, timesteps, guidance_scale, counter, lock, use_bf16=True):
...
def main():
    ...
    # 主进程负责总进度条
    with tqdm(total=total, desc="Total Progress", position=0) as pbar:
        last = 0
